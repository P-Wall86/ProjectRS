export const workshops = {
    "2026-04-23": {
        ...
        content: {
            description: `
                <p>El taller del 26 de abril estuvo enfocado en reflexionar sobre cómo podemos comenzar a poner en práctica el almacenamiento de agua, tal como se nos ha aconsejado para situaciones de emergencia.</p>
                <p>La invitación principal fue hacerlo de manera sencilla y realista, evaluando las posibilidades y circunstancias de cada una, entendiendo que no se trata de alcanzar algo perfecto de inmediato, sino de empezar.</p>
                <p>Durante el encuentro, contamos con la participación de hermanas que ya tienen experiencia en este hábito, quienes compartieron sus conocimientos y vivencias, especialmente en relación al uso de recipientes adecuados y la constancia en el tiempo. Sus aportes ayudaron a que el tema se volviera más cercano y aplicable.</p>
                <p>Además, se destacó la importancia de almacenar el agua en un lugar fresco, oscuro y alejado del calor, y de comenzar con pequeñas cantidades que puedan mantenerse en el tiempo, fomentando así un hábito sostenible y consciente.</p>
                <p>También se enseñó un método sencillo para limpiar y desinfectar botellas antes de utilizarlas, recomendando especialmente las botellas PET (como las de gaseosa), ya que están diseñadas para almacenar líquidos de forma segura, son resistentes, reutilizables y fáciles de conseguir en cualquier hogar.</p>
                <p>Más allá de lo práctico, el taller nos dejó la enseñanza de que la preparación también es una forma de cuidado y responsabilidad hacia nosotras mismas y nuestras familias.</p>
                <p><em>"Si estáis preparados, no temeréis."</em> <strong>(Doctrina y Convenios 38:30)</strong></p>`,
            points: [
                "Introducción",
                "Dinámica grupal",
                "Reflexión final"
            ...
            images: [
                "images/Infografia.webp"
            ]
        }
    },

    "2026-04-09": {
        title: "Probando la máquina nueva",
    ...
    "2026-03-21": {
        title: "184° Aniversario de la Sociedad de Socorro",
        ...
        content: {
            ...
            images: [
                "images/Group.webp",
                "images/OldFriends.webp",
            ]
        }
    },

    "2026-02-26": {
        title: "Armando el arreglo floral",
